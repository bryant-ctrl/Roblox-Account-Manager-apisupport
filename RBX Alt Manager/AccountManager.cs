    ...
    public partial class AccountManager : Form
    {
        ...
        private string SendResponse(HttpListenerContext Context)
        {
            ...
            if (Method == "LaunchAccount")
            {
                ...
                string LaunchData = request.QueryString["LaunchData"] ?? request.QueryString["launchData"] ?? "";

                account.JoinServer(PlaceId, JobID, FollowUser == "true", JoinVIP == "true", false, LaunchData);
